...
import {
  FaJs, FaPython, FaJava, FaRust, FaFile, FaSearch, FaCog, FaTrash,
} from 'react-icons/fa';
...
function FullScreenCodeContainer() {
    ...
    axios
      ...
      .catch((err: any) => {
        ...
        if (status === 429) {
          ...
          // Please read the blog on freeCodeCamp to learn how to setup your own RAPID API Judge0!`,
          //   10000
          // );
        }
        // setProcessing(false);
  ...
  const handleSaveClicked = () => {
    ...
    dispatch(createCodeSnippet(accessToken, {
      title, code, language, user_id: userId, public: codeIsPublic,
    }))
      .then((res) => {
        if (res === 'Success') {
    ...
    <div id="full_screen_code_container_container" className="full_screen_code_container_container">
      ...
      <div className="full_screen_code_container_right">
        <div className="full_screen_code_container_right_nav">
          ...
          <button type="button" className="compile_button" onClick={handleCompile}>Compile</button>
